        ...
        <section id="propos">
          <article id="henne">
            <ul class="propos">
              ...
              <li><button class="reserver">Reservez</button></li>
            </ul>
          </article>
          <article class="video">
          ...
          <ul class="livraisons">
            <li>
              <figure>
                ...
                <figcaption>
                  satisfait ou remboursée <br /><span>dans les 15 jours </span>
                </figcaption>
              </figure>
            </li>
            <li>
              <figure>
                ...
                <figcaption>
                  livraison offerte <br /><span>des 25€ d'achat</span>
                </figcaption>
              </figure>
            </li>
            <li>
              <figure>
                ...
                <figcaption>Livraison rapide</figcaption>
              </figure>
            </li>
            <li>
              <figure>
        ...
        <section id="newsletter">
          ...
          <article class="subscribe">
            ...
            <input
              ...
              class="newsletter"
            />
            <div class="subcribe"><button class="news">Subscribe</button></div>
          </article>
        </section>
      </div>
    </div>
...
input.newsletter {
  ...
  font-family: "Bellota", cursive;
  background-color: transparent;
  border-bottom: 3px solid rgb(200, 156, 98);
  border-top: inherit;
  border-left: inherit;
